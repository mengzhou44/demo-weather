  ...
  return (
    <section id="counseling" className={styles.container}>
      ...
      <div className={styles.content}>
          ...
          <p>
           We have partnered with UC Riverside to offer a dual program. After completing their high school diploma with us, students will be able to receive a  Preliminary Acceptance Letter from UC Riverside simultaneously. 					    
        </p> 
      </div>
